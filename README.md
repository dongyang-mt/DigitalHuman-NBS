...
(icon) dongyang@work:/opt/data/dongyang/code/neural-blend-shapes$ python evaluation.py --device=cuda:1 --model_path=./pre_trained
...
(neuralbs_no4) dongyang@work:/opt/data/dongyang/code/neural-blend-shapes$ python evaluation.py --device=cuda:1 --model_path=./pre_trained_20230111/
Preparing topology augmentation...
...
Skinning Weight L1 = 0.0179705
Vertex Mean Loss L2 = 0.0000612
Vertex Max Loss L2 = 0.0033100
Envelope Mean Loss L2 = 0.0000573
CD-J2J = 0.0115022
CD-J2B = 0.0111059
CD-B2B = 0.0125900
~~~
...
python train.py --envelope=1 --save_path=./pre_trained_20230110 --device=cuda:7
~~~
