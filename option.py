...
class BaseOptionParser:
    def __init__(self):
        ...
        self.parser.add_argument('--save_path', type=str, default='./pre_trained_20230111/')
...
class TrainingOptionParser(BaseOptionParser):
    def __init__(self):
        ...
        self.parser.add_argument('--envelope', type=int, default=1)
        ...
        self.parser.add_argument('--fast_train', type=int, default=0)
        self.parser.add_argument('--ee_order', type=int, default=1)
        self.parser.add_argument('--att_save_freq', type=int, default=10)
